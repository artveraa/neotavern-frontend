  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Surnom
        ...
        <Text style={styles.label}>E-mail de connexion
      ...
      {emptyErr && <Text style={[styles.label, styles.error]}> Des champs sont vides ! </Text>}

      <TouchableOpacity style={styles.btnSecondary} onPress={() => handleRegisterUser()}>
          <Text>Valider</Text>
      </TouchableOpacity>
